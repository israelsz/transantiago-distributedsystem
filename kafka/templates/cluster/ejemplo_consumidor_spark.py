...
spark = SparkSession.builder \
    ...
    .config("spark.mongodb.read.connection.uri", "mongodb://localhost:8008/RED.PARADEROS") \
    .config("spark.mongodb.read.database", "RED") \
    .config("spark.mongodb.read.collection", "PARADEROS") \
    .config("spark.mongodb.write.connection.uri", "mongodb://localhost:8008/RED.PARADEROS") \
...
kafka_bootstrap_servers = "144.22.52.73:9092"
