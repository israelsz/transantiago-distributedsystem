<template>
  <v-container class="cont">
    <v-row>
      ...
      <v-col v-for="(item, index) in jsonData" :key="index" cols="12" sm="1" md="4">
        <v-card class="mx-auto" max-width="344">
          <div class="color-div" :style="{ backgroundColor: item.color }" height="200px"></div>

          <div v-if="item.color == 'No hay color mas repetido'"><v-card-title>Sin color más repetido </v-card-title></div>
